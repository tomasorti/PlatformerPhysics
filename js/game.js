function Game() {
  ...
  for(var x = 0; x < this.grid.width; ++x) {
    this.grid.setCeiling(x, this.grid.height - 10, true);    
    this.grid.setCeiling(x, this.grid.height - 1, true);
  }

  this.player = [];

  this.player[0] = new PlatformerNode(0, 0, this.PLAYER_SIZE, this.PLAYER_SIZE, "red");
  this.grid.addNode(this.player[0]);

  this.player[1] = new PlatformerNode(500, 0, this.PLAYER_SIZE, this.PLAYER_SIZE, "green");
...
Game.prototype = {
  ...
  jumpKeyPressed(player) {
    if(!player.jump && player.onGround) {
      player.jump = true;
      player.setvy(this.PLAYER_JUMP_SPEED);
  ...
  keyDown(e) {
    switch(e.keyCode) {
      case this.P1_KEY_JUMP:
        this.jumpKeyPressed(this.player[0]);
        break;
      ...
      case this.P2_KEY_JUMP:
        this.jumpKeyPressed(this.player[1]);
        break;        
